window.FLOW_BOARD = {
  frames: [
    ...
    { id: "constellation", lane: "daily", title: "Constellation learning state — unavailable", status: "current", availability: "not-available", purpose: "Availability evidence: the component exists, but no current destination supplies learning data.", entry: "Not reachable in the current v2 demo", action: "No participant action available", exit: "Dashboard", asset: "assets/current/12-constellation.png" },
