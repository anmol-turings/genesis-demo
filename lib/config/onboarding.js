  ...
  body: {
    ...
    intents: {
      assess: {
        ...
        desc: 'Get a real read of your body before changing anything — sleep, energy, biomarkers.',
        questions: [
          {
          ...
          },
          {
            ...
            options: [
              ...
              { text: 'Longevity — biomarkers, aging well', target: 'o_long' },
            ],
          },
          {
      ...
      optimize: {
        ...
        destinations: [
        {
          ...
          desc: 'Healthspan, biomarkers, aging well — playing the long game with your body.',
          heroScene: 'walks-lighter',
          journey: {
            title: 'From good to a body that holds you for decades',
            opening: 'You\'re playing the long game. The ride is biomarkers, training, sleep — calibrated for healthspan, not just lifespan.',
          },
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { text: 'What is the next biomarker I should improve?', target: 'o_long' },
            ],
          },
          {
    ...
    intents: {
      ...
      manage: {
        ...
        destinations: [
        {
          ...
          desc: 'Chronic nervous-system activation; persistent bracing.',
          heroScene: 'focus-burns',
          journey: {
