...
export const DOMAINS = {
  body: {
    id: 'body',
    name: 'Body',
    blurb: 'Sleep, energy, movement and everyday physical wellbeing.',
    enabled: true,
    intents: {
      assess: {
        id: 'assess',
      ...
      manage: {
        id: 'manage',
        name: 'Steady what\'s hurting',
        desc: 'Address a specific issue — sleep, weight, energy, a chronic condition.',
        destinations: [
        {
          id: 'm_sleep',
          name: 'The unpaid ledger',
          desc: 'Sleep that has run short for a long time — and everything it touches.',
          ...
          firstMessage: {
            ...
            alchemist: 'The unpaid ledger compounds in silence. We pay the principal, not patch the nights.',
            explorer: 'Every long journey begins with the night before. We learn to make camp.',
            healer: 'Your body has been asking for sleep. We honour the request, gently, with consistency.',
          ...
          activities: [
            { id: 'fixed-wakeup', name: 'Fixed wake time', cadence: 'daily', description: 'Try waking at the same time every day, including weekends, for two weeks — consistency teaches the body when night begins.' },
            { id: 'wind-down', name: 'Wind-down hour', cadence: 'daily', description: 'One hour before bed: lights low, no screens, no work talk.' },
            { id: 'caffeine-cut', name: 'Caffeine cutoff', cadence: 'daily', description: 'Consider an earlier caffeine cutoff that fits your sensitivity and sleep schedule. The half-life is longer than most people think.' },
          ],
        },
        {
          id: 'm_energy',
          name: 'Running on empty',
          desc: 'Energy running lower than it should — carried by stress and willpower.',
          heroScene: 'rest-multiplier',
          journey: {
          ...
          activities: [
            { id: 'protein-anchor', name: 'Protein anchor', cadence: 'daily', description: 'Aim for a protein-led breakfast in the first part of the day, most days.' },
        ...
        },
        {
          ...
          desc: 'A body that doesn\'t feel like yours right now — gaining or losing without meaning to.',
          heroScene: 'rest-multiplier',
          journey: {
      ...
      optimize: {
        ...
        destinations: [
        {
          ...
          activities: [
            { id: 'bloods-quarterly', name: 'Quarterly blood panel', cadence: 'monthly', description: 'Consider a quarterly fasted blood panel with your doctor, and watch the trend over time rather than any single number.' },
            ...
            { id: 'protein-1g', name: 'A protein target that fits you', cadence: 'daily', description: 'Experiment with a higher protein intake, spread across meals. Around 1g per pound of body weight is a common anchor — adjust to your body and, if in doubt, your doctor.' },
          ],
        },
        {
          id: 'o_perf',
        ...
        },
        {
          ...
          activities: [
            ...
            { id: 'cool-room', name: 'Cool, dark, quiet bedroom', cadence: 'daily', description: 'Experiment with a cooler, darker, quieter bedroom. Many sleep best somewhere around 16–19°C — find the number that works for you.' },
  ...
  brain: {
    id: 'brain',
    name: 'Brain & Mind',
    blurb: 'Mental state, attention, memory and composure under pressure.',
    enabled: true,
    intents: {
      assess: {
        id: 'assess',
        name: 'Notice what is asking for attention',
        desc: 'Read what is most present in your mind — emotionally and cognitively.',
        questions: [
          {
      ...
      manage: {
        ...
        desc: 'Work with a pattern that feels turned up — tension, flatness, or repeated thinking.',
        destinations: [
        {
          id: 'm_anx',
          name: 'Always on high alert',
          desc: 'A system that has been running on high — hard to switch off, even when it\'s safe to.',
          heroScene: 'focus-burns',
          journey: {
          ...
          activities: [
            { id: 'physiological-sigh', name: 'The physiological sigh', cadence: 'every-90m', description: 'Two short inhales through the nose, one long exhale. Three times. Many people find it settles the system — try it and see how it lands for you.' },
            ...
            { id: 'cold-water', name: 'Cold water on the face', cadence: 'on-trigger', description: 'Splash cold water on your face when tension rises. Triggers the dive reflex. Skip this one if you have a heart condition or cold exposure feels wrong for you.' },
          ],
        },
        {
          id: 'm_low',
          name: 'The grey hour',
          desc: 'A low that has lingered — colour, pleasure, and motivation harder to find.',
      ...
      optimize: {
        ...
        },
        {
          ...
          activities: [
            ...
            { id: 'sleep-consolidation', name: 'Sleep for consolidation', cadence: 'daily', description: 'Prioritise a full night\'s sleep — for most people that\'s somewhere in the 7–9 hour range. Memory consolidates overnight.' },
        ...
        },
        {
          ...
          activities: [
            ...
            { id: 'cold-exposure', name: 'Cold exposure', cadence: 'weekly', description: 'If it suits you, try a few short cold-exposure sessions a week — start small and see how your body responds. Skip this one if you have a heart or circulation condition, or check with your doctor first.' },
  ...
  relationships: {
    id: 'relationships',
    name: 'Relationships',
    blurb: 'Close relationships, family, friends and social connection.',
    enabled: true,
    intents: {
      assess: {
        id: 'assess',
      ...
      manage: {
        ...
        destinations: [
        {
          id: 'm_part',
          name: 'The slow drift',
          desc: 'Distance in an important close relationship — being near without really connecting.',
          heroScene: 'felt-named-free',
          journey: {
            title: 'From quiet drift to closer than you\'ve been in years',
            opening: 'The connection matters. What has gone quiet is the habit of reaching. We rebuild it — one real question and one phones-down moment at a time.',
          },
          ...
          firstMessage: {
            ...
            healer: 'Connection fades through neglect. We tend to it, gently, this week.',
          ...
          activities: [
            { id: 'one-question', name: 'One real question', cadence: 'daily', description: 'Ask the person one real question that is not logistical.' },
            { id: 'phones-down', name: 'Phones-down time', cadence: 'weekly', description: 'Spend time together once this week with no phones in the room.' },
      ...
      optimize: {
        ...
        {
          id: 'o_int',
          name: 'Closer with someone important',
          desc: 'Move from surface connection to being genuinely close.',
          heroScene: 'felt-named-free',
          journey: {
            title: 'From coexisting to truly close',
            opening: 'The connection is real. The ride strengthens it through real questions, real time, and real reaching.',
          },
          ...
          activities: [
            { id: 'weekly-real-date', name: 'Dedicated connection time', cadence: 'weekly', description: 'Set aside one distraction-free hour together this week.' },
            { id: 'daily-question', name: 'One real question', cadence: 'daily', description: 'Ask one real question and listen without rushing to fix anything.' },
            { id: 'micro-affection', name: 'One act of care', cadence: 'daily', description: 'Do one small, thoughtful thing that helps the person feel noticed.' },
          ],
        },
        {
          id: 'o_circ',
  ...
  skills: {
    ...
    blurb: 'Work strain, stalled momentum, the weight of leading.',
    enabled: true,
    intents: {
      assess: {
        id: 'assess',
        name: 'Find where you really stand',
        desc: 'Get an honest read on whether you\'re regaining ground, plateaued, or growing.',
        questions: [
          {
            prompt: 'When you think about work right now, what is loudest?',
            options: [
              { text: 'Running low — steadier ground is the priority', target: 'm_burn' },
      ...
      manage: {
        id: 'manage',
        name: 'Steady what\'s strained',
        desc: 'Address a specific issue — work strain, role weight, role misfit.',
        destinations: [
        {
          id: 'm_burn',
          name: 'Running on fumes',
          desc: 'Sustained work strain that calls for a steadier rhythm.',
          heroScene: 'rest-multiplier',
          journey: {
...
// Replace the original draft questions with the Detalytics August 2026
// student/Saudi-adapted language while retaining the established realms.
applyAssessmentV3(DOMAINS);
...
export { ASSESSMENT_PROFILES, ASSESSMENT_ROUTE_LABELS, getAssessmentProfile };

function resolveDomainForProfile(domain, profile) {
  if (!domain) return domain;
  if (domain.id !== 'skills') return domain;
  if (profile?.context === 'student') {
    return {
      ...domain,
      name: 'Competency, Skills & Study',
      blurb: 'Study strain, skills, academic growth, role fit and focused output.',
    };
  }
  return {
    ...domain,
    name: 'Competency, Skills & Work',
    blurb: 'Work strain, skills, career growth, role fit and focused output.',
  };
}

export function getDomain(domainId, profile) {
  return resolveDomainForProfile(DOMAINS[domainId], profile);
}

export function getDomainList(profile) {
  // Detalytics review order: Body → Brain & Mind → Relationships → Skills.
  const order = ['body', 'brain', 'relationships', 'skills'];
  return order
    .map(id => DOMAINS[id])
    .filter(d => d && d.enabled !== false)
    .map(d => resolveDomainForProfile(d, profile))
...
export function getQuestions(domainId, intentId, profile) {
  const questions = DOMAINS[domainId]?.intents[intentId]?.questions ?? [];
  return resolveAssessmentQuestions(questions, profile);
}
...
export function diagnose(domainId, intentId, answers, profile) {
  const intent = DOMAINS[domainId]?.intents[intentId];
  if (!intent) return null;
  const questions = getQuestions(domainId, intentId, profile);
  const tally = {};
  let supportSignalCount = 0;
  for (const a of answers) {
    const q = questions[a.questionIndex];
    const opt = q?.options[a.optionIndex];
    if (!opt) continue;
    if (opt.supportSignal) supportSignalCount += 1;
    if (!opt.target) continue;
    tally[opt.target] = (tally[opt.target] || 0) + 1;
  }
  const ranked = Object.entries(tally).sort((a, b) => b[1] - a[1]);
  const supportSuggested = domainId === 'brain' && intentId === 'manage' && supportSignalCount >= 3;
  if (!ranked.length) {
    return {
      destinationId: null,
      intent: intentId,
  ...
  return {
    ...
    runnerUpScore,
    tally,
    needsChoice: ranked[0][1] === runnerUpScore,
    supportSignalCount,
    supportSuggested,
  };
}
