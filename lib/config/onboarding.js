...
export const DOMAINS = {
  // ──────────────────────────────────────────────────────────────────────
  // COMPETENCY & SKILLS (surfaces Work in v1)
  // ──────────────────────────────────────────────────────────────────────
  skills: {
    id: 'skills',
  ...
  money: {
    id: 'money',
    enabled: false, // hidden in v1, kept for future skill verticals
    name: 'Money',
...
// Hidden taxonomy field. Not user-visible; used for analytics and
// future sales segmentation. Values: 'assess' | 'manage' | 'optimize'.
export function getTier(domainId, problemId) {
  return DOMAINS[domainId]?.problems[problemId]?.tier ?? null;
}
