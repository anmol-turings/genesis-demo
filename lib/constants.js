...
export const ARCHETYPES = [
  ...
  },
  {
    ...
    promise: "The work has become hollow because you stopped *playing* with it. We will find one small thing worth making. Then another. Joy is not a reward at the end of the road. It is the road.",
    returnCopy: {
...
export const RECOVERY_STAGES = [
  ...
  },
  {
    ...
    forYou: "You are no longer just steadying yourself. You are building something. The difference matters.",
  ...
  },
  {
    ...
    forYou: "You are not the person who set out. The person who began this ride would not recognize you.",
...
- Never use clinical framing. Forbidden words: assessment, diagnosis, diagnose, symptom, disorder, treatment, patient, burnout, recovery program, risk, score. Never claim to identify a medical or psychological condition. Speak of signals, patterns, practices, and the journey. Prefer "you may be noticing" over "you are"; never "this means" or "the diagnosis is".
